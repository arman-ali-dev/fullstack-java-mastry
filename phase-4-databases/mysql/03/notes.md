...
- FULL JOIN workaround in MySQL (using UNION of LEFT + RIGHT JOIN) — rare in practice, look up when needed.
- Exact performance differences between subqueries vs JOINs — good to know exists, not critical to memorize now.
